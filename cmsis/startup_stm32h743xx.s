...
.word  _sidata_int_dtcm
/* start address for the .data.int_dtcm section. defined in linker script */
.word  _sdata_int_dtcm
/* end address for the .data.int_dtcm section. defined in linker script */
.word  _edata_int_dtcm
/* start address for the .bss.int_dtcm section. defined in linker script */
.word  _sbss_int_dtcm
/* end address for the .bss.int_dtcm section. defined in linker script */
.word  _ebss_int_dtcm
...
/* Copy the data segment initializers from flash to SRAM */
  ldr r0, =_sdata_int_dtcm
  ldr r1, =_edata_int_dtcm
  ldr r2, =_sidata_int_dtcm
  movs r3, #0
  b LoopCopyDataInit
...
/* Zero fill the bss segment. */
  ldr r2, =_sbss_int_dtcm
  ldr r4, =_ebss_int_dtcm
  movs r3, #0
  b LoopFillZerobss
