...
static const struct bsp_utils_bus_des bsp_utils_bus_des[] = {
	{ .addr_lo = 0x40000000, .addr_hi = 0x4000D400, .name = "apb1", .get_freq = HAL_RCC_GetPCLK1Freq },	{ .addr_lo = 0x40010000, .addr_hi = 0x40017800, .name = "apb2", .get_freq = HAL_RCC_GetPCLK2Freq },
	{ .addr_lo = 0x40020000, .addr_hi = 0x400C0000, .name = "ahb1", .get_freq = HAL_RCC_GetHCLKFreq },	{ .addr_lo = 0x48020000, .addr_hi = 0x48022C00, .name = "ahb2", .get_freq = HAL_RCC_GetHCLKFreq },
	{ .addr_lo = 0x50000000, .addr_hi = 0x50004000, .name = "apb3", .get_freq = HAL_RCCEx_GetD1PCLK1Freq }, { .addr_lo = 0x51000000, .addr_hi = 0x52009000, .name = "ahb3", .get_freq = HAL_RCC_GetHCLKFreq },
	{ .addr_lo = 0x58000000, .addr_hi = 0x58006C00, .name = "apb4", .get_freq = HAL_RCCEx_GetD3PCLK1Freq }, { .addr_lo = 0x58020000, .addr_hi = 0x580267FF, .name = "ahb4", .get_freq = HAL_RCC_GetHCLKFreq }
};
...
static const struct bsp_utils_periph_des bsp_utils_periph_des[] = {
	...
	{ .addr_lo = 0x40003800, .addr_hi = 0x40003BFF, .name = "SPI2", .bus_des = BSP_UTILS_APB1_DES, 
	  .irqs =
	  { [0] = { .name = "", irqn = SPI2_IRQn, .fun = HAL_SPI_IRQHandler },
	    [1] = NULL }
	},
	...
	{ .addr_lo = 0x40004400, .addr_hi = 0x400047FF, .name = "USART2", .bus_des = BSP_UTILS_APB1_DES, 
	  .irqs =
	  { [0] = { .name = "", irqn = USART2_IRQn, .fun = HAL_USART_IRQHandler },
	    [1] = NULL }
	},

	{ .addr_lo = 0x40004800, .addr_hi = 0x40004BFF, .name = "USART3", .bus_des = BSP_UTILS_APB1_DES, 
	  .irqs =
	  { [0] = { .name = "", irqn = USART3_IRQn, .fun = HAL_USART_IRQHandler },
	    [1] = NULL }
	},
	...
	{ .addr_lo = 0x40005400, .addr_hi = 0x400057FF, .name = "I2C1", .bus_des = BSP_UTILS_APB1_DES, 
	  .irqs =
	  { [0] = { .name = "EV", irqn = I2C1_EV_IRQn, .fun = HAL_I2C_EV_IRQHandler },
	    [1] = { .name = "ER", irqn = I2C1_ER_IRQn, .fun = HAL_I2C_ER_IRQHandler },
	    [2] = NULL }
	},

	{ .addr_lo = 0x40005800, .addr_hi = 0x40005BFF, .name = "I2C2", .bus_des = BSP_UTILS_APB1_DES, 
	  .irqs =
	  { [0] = { .name = "EV", irqn = I2C2_EV_IRQn, .fun = HAL_I2C_EV_IRQHandler },
	    [1] = { .name = "ER", irqn = I2C2_ER_IRQn, .fun = HAL_I2C_ER_IRQHandler },
	    [2] = NULL }
	},
	...
	{ .addr_lo = 0x4000A000, .addr_hi = 0x4000A3FF, .name = "FDCAN1", .bus_des = BSP_UTILS_APB1_DES, 
	  .irqs =
	  { [0] = { .name = "IT0", irqn = FDCAN1_IT0_IRQn, .fun = HAL_FDCAN_IRQHandler },
	    [1] = { .name = "IT1", irqn = FDCAN1_IT1_IRQn, .fun = HAL_FDCAN_IRQHandler },
	    [2] = NULL }
	},

	{ .addr_lo = 0x4000A400, .addr_hi = 0x4000A7FF, .name = "FDCAN2", .bus_des = BSP_UTILS_APB1_DES, 
	  .irqs =
	  { [0] = { .name = "IT0", irqn = FDCAN2_IT0_IRQn, .fun = HAL_FDCAN_IRQHandler },
	    [1] = { .name = "IT1", irqn = FDCAN2_IT1_IRQn, .fun = HAL_FDCAN_IRQHandler },
	    [2] = NULL }
	},
	...
	{ .addr_lo = 0x40010000, .addr_hi = 0x400103FF, .name = "TIM1", .bus_des = BSP_UTILS_APB2_DES, 
	  .irqs =
	  { [0] = { .name = "BRK", irqn = TIM1_BRK_IRQn, .fun = HAL_TIM_IRQHandler },
	    [1] = { .name = "UP", irqn = TIM1_UP_IRQn, .fun = HAL_TIM_IRQHandler },
	    [2] = { .name = "TRG_COM", irqn = TIM1_TRG_COM_IRQn, .fun = HAL_TIM_IRQHandler },
	    [3] = { .name = "CC", irqn = TIM1_CC_IRQn, .fun = HAL_TIM_IRQHandler },
	    [4] = NULL }
	},

	{ .addr_lo = 0x40010400, .addr_hi = 0x400107FF, .name = "TIM8", .bus_des = BSP_UTILS_APB2_DES, 
	  .irqs =
	  { [0] = { .name = "BRK", irqn = TIM8_BRK_IRQn, .fun = HAL_TIM_IRQHandler },
	    [1] = { .name = "UP", irqn = TIM8_UP_IRQn, .fun = HAL_TIM_IRQHandler },
	    [2] = { .name = "TRG_COM", irqn = TIM8_TRG_COM_IRQn, .fun = HAL_TIM_IRQHandler },
	    [3] = { .name = "CC", irqn = TIM8_CC_IRQn, .fun = HAL_TIM_IRQHandler },
	    [4] = NULL }
	},

	{ .addr_lo = 0x40011000, .addr_hi = 0x400113FF, .name = "USART1", .bus_des = BSP_UTILS_APB2_DES, 
	  .irqs =
	  { [0] = { .name = "", irqn = USART1_IRQn, .fun = HAL_USART_IRQHandler },
	    [1] = NULL }
	},
	...
	{ .addr_lo = 0x40013000, .addr_hi = 0x400133FF, .name = "SPI1", .bus_des = BSP_UTILS_APB2_DES, 
	  .irqs =
	  { [0] = { .name = "", irqn = SPI1_IRQn, .fun = HAL_SPI_IRQHandler },
	    [1] = NULL }
	},
	...
	{ .addr_lo = 0x40020000, .addr_hi = 0x400203FF, .name = "DMA1", .bus_des = BSP_UTILS_AHB1_DES, 
	  .irqs =
	  { [0] = { .name = "Stream7", irqn = DMA1_Stream7_IRQn, .fun = NULL },
	    [1] = NULL }
	},
	...
	{ .addr_lo = 0x40022000, .addr_hi = 0x400223FF, .name = "ADC", .bus_des = BSP_UTILS_AHB1_DES, 
	  .irqs =
	  { [0] = { .name = "", irqn = ADC_IRQn, .fun = HAL_ADC_IRQHandler },
	    [1] = NULL }
	},
	...
	{ .addr_lo = 0x50003000, .addr_hi = 0x50003FFF, .name = "WWDG1", .bus_des = BSP_UTILS_APB3_DES, 
	  .irqs =
	  { [0] = { .name = "", irqn = WWDG_IRQn, .fun = HAL_WWDG_IRQHandler },
	    [1] = NULL }
	},
	...
	{ .addr_lo = 0x52002000, .addr_hi = 0x52002FFF, .name = "FLASH", .bus_des = BSP_UTILS_AHB3_DES, 
	  .irqs =
	  { [0] = { .name = "", irqn = FLASH_IRQn, .fun = HAL_FLASH_IRQHandler },
	    [1] = NULL }
	},
	...
	{ .addr_lo = 0x58000000, .addr_hi = 0x580003FF, .name = "EXTI", .bus_des = BSP_UTILS_APB4_DES, 
	  .irqs =
	  { [0] = { .name = "0", irqn = EXTI0_IRQn, .fun = HAL_EXTI_IRQHandler },
	    [1] = { .name = "1", irqn = EXTI1_IRQn, .fun = HAL_EXTI_IRQHandler },
	    [2] = { .name = "2", irqn = EXTI2_IRQn, .fun = HAL_EXTI_IRQHandler },
	    [3] = { .name = "3", irqn = EXTI3_IRQn, .fun = HAL_EXTI_IRQHandler },
	    [4] = { .name = "4", irqn = EXTI4_IRQn, .fun = HAL_EXTI_IRQHandler },
	    [5] = { .name = "9_5", irqn = EXTI9_5_IRQn, .fun = HAL_EXTI_IRQHandler },
	    [6] = { .name = "15_10", irqn = EXTI15_10_IRQn, .fun = HAL_EXTI_IRQHandler },
	    [7] = NULL }
	},
	...
	{ .addr_lo = 0x58004000, .addr_hi = 0x580043FF, .name = "RTC", .bus_des = BSP_UTILS_APB4_DES, 
	  .irqs =
	  { [0] = { .name = "WKUP", irqn = RTC_WKUP_IRQn, .fun = RTC_WKUP_IRQHandler },
	    [1] = { .name = "Alarm", irqn = RTC_Alarm_IRQn, .fun = RTC_Alarm_IRQHandler },
	    [2] = NULL }
	},
	...
	{ .addr_lo = 0x58024400, .addr_hi = 0x580247FF, .name = "RCC", .bus_des = BSP_UTILS_APB4_DES, 
	  .irqs =
	  { [0] = { .name = "", irqn = RCC_IRQn, .fun = RCC_IRQHandler },
	    [1] = NULL }
	},
